...
<head>
    ...
    <script>
        ...
        function clicked(a)
        {
            ...
            if (a=='1')
            {
                    xmlhttp.open("GET","<?php echo $dirname;?>/likesdbconnect.php?liked=1",true);
            }
            else
            {
                    xmlhttp.open("GET","<?php echo $dirname;?>/likesdbconnect.php?liked=0",true);
            }
            xmlhttp.send();
                ...
                if (xmlhttp.readyState==4 && xmlhttp.status==200) 
                    {
                        ...
                        {   
                            ...
                            window.location="<?php echo $dirname;?>/likes.php?fbid=<? echo $_SESSION['fbid'];?>";
                        }
       ...
       <div class="nav">
            ...
            <div class="content">
                    <div id="likebox" class="likebox">
                        <div class="fb-like-box" data-href="<?php echo $likepageurl ?>" data-width="300" data-height="300" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
                    </div>
